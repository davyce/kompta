        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-5 dark:bg-[#1e2229]">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={() => setShowForm(false)} className="text-[#717182] hover:text-[#17211f] dark:hover:text-white">
                <X size={18} />
              </button>
            </div>
            <form
            ...
            >
              <div>
                <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.title")}</label>
                <input
                  required
                  value={form.title}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.contactName")}</label>
                  <input
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.contactPhone")}</label>
                  <input
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.contactEmail")}</label>
                <input
                  type="email"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.estimatedAmount")}</label>
                  <input
                    type="number"
                    min={0}
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.probability")}</label>
                  <input
                    type="number"
                    min={0}
                    max={100}
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-[#717182]">{tr("crm.form.expectedCloseDate")}</label>
                <input
                  type="date"
